...
namespace consoleLargestSiblingNumber
{
    public class Program
    {
        ...
        public static int getLargestSibling(int x)
        {
            ...
            if (int.Parse(_arrangedStringNumbers) > largestSiblingLimit)
                return -1;
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("O maior número irmão é:");
            if (number != null)
            {
                int largestSiblingNumber = getLargestSibling(int.Parse(number));
